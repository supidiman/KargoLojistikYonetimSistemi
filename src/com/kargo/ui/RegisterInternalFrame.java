...
public class RegisterInternalFrame extends JInternalFrame 
{
    ...
    {
        super("yeni müsteri ekeleme ",false,true,false,true);
        this.servis=servis;
        this.setSize(350,350);
        this.setLayout(null);
        this.setLocation(50,80);
        
        JLabel l1=new JLabel("adınız:"); l1.setBounds(30,30,100,25); this.add(l1);
        ad=new JTextField(); ad.setBounds(130,30,150,25); this.add(ad);
        
        JLabel l2=new JLabel("kimlik:"); l2.setBounds(30,70,100,25); this.add(l2);
        kimlik=new JTextField(); kimlik.setBounds(130,70,150,25); this.add(kimlik);
        
        JLabel l3=new JLabel("tel:"); l3.setBounds(30, 110, 100, 25); this.add(l3);
        ...
        JButton btn = new JButton("KAYDET"); btn.setBounds(130, 200, 150, 35); this.add(btn);
        ...
        btn.addActionListener(new ActionListener() 
        {
            public void actionPerformed(ActionEvent e)
            {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null,"BASARIYLA KAYDEDILDI");
                    ad.setText(""); kimlik.setText(""); tel.setText(""); adres.setText("");
                }
                catch(Exception exe) {
                    JOptionPane.showMessageDialog(null,"HATA: "+exe.getMessage());
                }
            }
        });
    }
